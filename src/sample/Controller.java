...
public class Controller extends Component {
  ...
  @FXML
  private Button btnCleanServer;

  @FXML
  private Button btnCleanCliente;

  @FXML
  private Button copyServidor;

  @FXML
  private Button copyCliente;
  ...
  public void copyToClipboard(ActionEvent actionEvent) {
    String text = "";
    if (actionEvent.getSource().equals(copyCliente)) {
      text = recibidoCliente.getText();
    } else if (actionEvent.getSource().equals(copyServidor)) {
      text = recibidoServidor.getText();
    }
  ...
  public void cleanText(ActionEvent actionEvent) {
    if (actionEvent.getSource().equals(btnCleanCliente)) {
      recibidoCliente.setText("");
    } else if (actionEvent.getSource().equals(btnCleanServer)) {
      recibidoServidor.setText("");
    }
  }
    ...
    if (conexionCliente.getText().equals("Conectar")) {
      if (validarIP(hostCliente.getText()) && validarPuerto(puertoCliente.getText())) {
        ...
        if (cliente.isConnected()) {
          ...
          notificar(notCliente, "No se pudo conectar con el servidor.", Estado.ERROR);
        }
      } else {
  ...
  public void clientesConectados(int clientesConectados) {
    synchronized (infoServidor) {
      infoServidor.setText(clientesConectados + "");
    }
  }
